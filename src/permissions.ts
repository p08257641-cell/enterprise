...
export const ROLE_MODULES: Record<string, string[]> = {
  ...
  'HR Manager': ['HR', 'Payroll', 'Intelligence', 'Learning Management (LMS)'],
  'HR Officer': ['HR', 'Payroll', 'Intelligence', 'Learning Management (LMS)'],
  ...
  'Department Head': ['HR', 'Administration', 'Intelligence', 'Learning Management (LMS)'],
