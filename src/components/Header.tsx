    ...
    <header className="sticky top-0 z-45 flex h-16 w-full items-center justify-between border-b border-slate-200 bg-white/90 backdrop-blur-md px-4 md:px-6">
      ...
      <div className="flex items-center gap-2 md:gap-4">
        ...
        <div className="flex items-center gap-1.5 border-l border-slate-200 pl-2 md:pl-4">
          ...
          <div className="relative">
            <select
              ...
              className="rounded-md border border-slate-200 bg-slate-50/50 hover:bg-slate-50 py-1.5 pl-2 pr-8 text-xs font-semibold text-slate-900 outline-hidden focus:border-slate-900 focus:ring-1 focus:ring-slate-900 cursor-pointer max-w-[100px] sm:max-w-[180px] truncate"
            >
          ...
          <div className="flex items-center gap-1.5 border-l border-slate-200 pl-2 md:pl-4">
            ...
            <div className="relative">
              <select
                ...
                className="rounded-md border border-slate-200 bg-slate-50/50 hover:bg-slate-50 py-1.5 pl-2 pr-8 text-xs font-medium text-slate-700 outline-hidden focus:border-slate-900 focus:ring-1 focus:ring-slate-900 cursor-pointer max-w-[80px] sm:max-w-[150px] truncate"
              >
        ...
        {selectedUser.activeRole === 'Super Admin' && (
          <div className="flex items-center gap-1.5 bg-slate-100 text-slate-900 border border-slate-200 px-2 md:px-2.5 py-1 rounded text-xs font-semibold animate-pulse">
