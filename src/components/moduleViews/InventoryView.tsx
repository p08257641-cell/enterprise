              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <Select value={stockCronDay} onChange={e => setStockCronDay(e.target.value)}>
                    <option value="1">Monthly (1st of Month)</option>
                    <option value="15">Monthly (15th of Month)</option>
                    <option value="28">Monthly (End of Month)</option>
                ...
                <div>
                  ...
                  <div className="space-y-1.5">
                    <Input
                      type="time"
                      value={stockCronTime}
                      onChange={e => setStockCronTime(e.target.value)}
                    ...
                    <div className="flex flex-wrap gap-1">
                      ...
                      {['08:00', '09:00', '12:00', '17:00', '23:59'].map(t => (
                        <button
                          key={t}
                          type="button"
                          onClick={() => setStockCronTime(t)}
                          className={`fs-3xs font-mono px-1.5 py-0.5 rounded border transition-colors ${
                            stockCronTime === t ? 'bg-amber-100 text-amber-800 border-amber-300 font-bold' : 'bg-slate-100 text-slate-600 border-slate-200 hover:bg-slate-200'
                          }`}
                        >
                          {t}
                        </button>
