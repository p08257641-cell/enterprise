            ...
            <div className="w-full max-w-lg rounded-3xl border border-slate-200 bg-white shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-150">
              ...
              <div className="p-6 space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <Label>Audit Day / Frequency</Label>
                  ...
                  <div>
                    ...
                    <div className="space-y-1.5">
                      <Input
                        type="time"
                        value={crmCronTime}
                        onChange={e => setCrmCronTime(e.target.value)}
                      ...
                      <div className="flex flex-wrap gap-1">
                        ...
                        {['08:00', '09:00', '12:00', '17:00', '23:59'].map(t => (
                          <button
                            key={t}
                            type="button"
                            onClick={() => setCrmCronTime(t)}
                            className={`fs-3xs font-mono px-1.5 py-0.5 rounded border transition-colors ${
                              crmCronTime === t ? 'bg-violet-100 text-violet-800 border-violet-300 font-bold' : 'bg-slate-100 text-slate-600 border-slate-200 hover:bg-slate-200'
                            }`}
                          >
                            {t}
                          </button>
